...
public class EnitiyShader extends StaticShader{
	
	private static final String VERTEX_FILE = "src.shaders/EntityShader/vertexShader.txt";
	private static final String FRAGMENT_FILE = "src.shaders/EntityShader/fragmentShader.txt";
